...
// This constant is still here for reference or if used in client-side logic not involving direct API calls.
// The primary model selection for API calls is now handled in the PHP backend.
